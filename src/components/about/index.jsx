      ...
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          ...
          <p className="font-light  text-xs sm:text-sm md:text-base   ">
            ...
            tools and languages, with C++ casting the core of my
            enchantments. I primarily wield tools like python, mern with
            precision, crafting seamless apps built full of features to serve the modern world connecting realms
            (users) across the digital universe. The ancient arts of the
            sql empower me to create fast, secure, and dynamic experiences,
            while my analytical skills ensure every creation is not only functional
            but higly resourceful. Join me as I continue to explore new
        ...
        <ItemLayout className={"col-span-full"}>
          <img
            className="w-full h-auto"
            src={`https://skillicons.dev/icons?i=appwrite,aws,babel,bootstrap,css,d3,docker,firebase,git,github,graphql,html,js,jquery,kubernetes,linux,mongodb,mysql,netlify,nextjs,nodejs,npm,postgres,react,redux,tailwind,threejs,vercel,vite,vscode,yarn`}
            alt="CodeBucks"
            loading="lazy"
          />
          {/* cloudflare */}
